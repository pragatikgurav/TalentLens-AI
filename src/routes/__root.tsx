  ...
  return (
    <div className="flex min-h-screen items-center justify-center gradient-mesh-bg px-4">
      <div className="glass-panel max-w-md rounded-2xl p-10 text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center justify-center rounded-lg gradient-primary-bg px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-elegant transition hover:opacity-90"
        >
          Go home
        </Link>
      </div>
      ...
      <div className="glass-panel max-w-md rounded-2xl p-8 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="rounded-lg gradient-primary-bg px-4 py-2 text-sm font-medium text-primary-foreground"
          >
            Try again
          </button>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TalentLens — AI Resume Screening" },
      {
        ...
        content:
          "AI-powered resume parsing, semantic matching, and candidate ranking for modern hiring teams.",
      },
